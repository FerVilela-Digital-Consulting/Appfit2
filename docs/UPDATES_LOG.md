...
### Cambios
- Se configuro `public/icono.ico` como icono principal para pesta̱as.
...
## 2026-03-30 - Rework de recorridos por pesta̱a y mejora de registro de alimentos
...
### Cambios
- Se consolido el recorrido guiado contextual por pesta̱a (centro operativo, entrenamiento y alimentacion) manteniendo el mismo estilo base.
...
- Se incorporo `Biblioteca` como pesta̱a superior en entrenamiento para que el recorrido y el acceso funcional sean directos.
