...
export const TRAINING_COPY = {
  ...
  es: {
    ...
    week: "Semana",
    weekDescription: "Asigna rutina, descanso o deja el día vacío.",
    todayBadge: "Hoy",
    unassigned: "Sin asignar",
    quickStart: "Inicio rápido",
    quickStartDescription: "Inicia cualquier rutina aunque no esté programada hoy.",
    ...
    exerciseLibraryDescription: "Base global más ejercicios personalizados.",
    ...
    noExerciseHistory: "Aún no hay sesiones registradas para este ejercicio.",
    ...
    deleteRoutineDescription: "Se eliminará la rutina y su bloque de ejercicios. Los días programados quedarán sin asignar.",
    deleteRoutineConfirm: "Eliminar rutina",
    activeExerciseCard: "Bloque de ejercicio",
    target: "Objetivo",
    restLabel: "Descanso",
    previousPerformance: "Último rendimiento",
