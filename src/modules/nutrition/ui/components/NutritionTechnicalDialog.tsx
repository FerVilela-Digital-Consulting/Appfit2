    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="app-dialog-surface max-h-[90vh] max-w-4xl overflow-y-auto p-4 sm:p-6">
          <DialogHeader>
            ...
            <DialogDescription>
              Ajusta perfiles, metas y parametros metabolicos sin bloquear el flujo principal de registro diario.
            </DialogDescription>
          </DialogHeader>
        <div className="space-y-5">
          ...
          <div className="app-surface-panel rounded-[24px] p-4 sm:rounded-[28px] sm:p-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="app-surface-caption text-[11px] font-semibold uppercase tracking-[0.26em]">Perfiles nutricionales</div>
              <Button
                type="button"
                size="sm"
            ...
            <div className="mt-4 space-y-3">
              {profileOptions.length === 0 ? (
                <div className="app-panel-block app-surface-muted rounded-2xl border-dashed px-4 py-5 text-sm">
                  Crea perfiles Base, Heavy o Recovery para ajustar el dia sin duplicar comidas.
                </div>
              ) : (
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-3">
                        <div className="min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            {profileRow.is_archived ? <span className="app-surface-caption text-[10px] uppercase tracking-[0.2em]">Archivado</span> : null}
                          </div>
