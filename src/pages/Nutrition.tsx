          ...
          <aside className="space-y-5 xl:sticky xl:top-6 xl:self-start">
            <div className="app-surface-panel rounded-[28px] p-5">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="mt-1 text-lg font-bold text-white">{effectiveProfileLabel}</h3>
                </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="rounded-2xl border border-white/8 bg-slate-950/80 p-4">
                  ...
                  <div className="mt-2 text-3xl font-black text-white">{formatMetric(target?.tdee)}</div>
                  <div className="text-xs text-slate-500">antes del arquetipo</div>
                </div>
                <div className="rounded-2xl border border-white/8 bg-slate-950/80 p-4">
                  <div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Ajuste</div>
                  <div className="mt-2 text-3xl font-black text-white">{target ? `${target.archetypeDelta >= 0 ? "+" : ""}${target.archetypeDelta}` : "--"}</div>
                  <div className="text-xs text-slate-500">kcal del arquetipo</div>
                </div>
              </div>
            ...
            <div className="app-surface-panel rounded-[28px] p-5">
              ...
              <div className="mt-4 flex items-end justify-between">
                <div><div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Consumido</div><div className="text-4xl font-black text-white">{formatMetric(totals?.calories)}</div></div>
                <div className="text-right"><div className="text-[10px] uppercase tracking-[0.24em] text-slate-500">Meta</div><div className="text-3xl font-black text-primary">{formatMetric(goals?.calorie_goal)}</div></div>
              </div>
