  ...
  return (
    <div className="app-shell min-h-screen px-4 py-5 text-foreground sm:px-6 sm:py-8">
      <div className="mx-auto max-w-[1540px] space-y-6">
        <section className="app-surface-hero rounded-[28px] px-4 py-5 sm:px-8 sm:py-8">
